...
//        $this->assign('first_category_list',$cate->getFirst());
//        $this->assign('second_category_list',$cate->getSecond());
//        $this->assign('third_category_list',$cate->getThird());
//        $this->assign('four_category_list',$cate->getFour());
        $this->display();
        $this->getCategory();
