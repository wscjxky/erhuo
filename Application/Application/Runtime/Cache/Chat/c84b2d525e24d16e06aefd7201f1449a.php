...
<div class="weui-tab__bd">
            <div class="weui-search-bar" id="searchBar">
                <div class="result-box">
                    <i   id="category" class="result-icon result-fail"></i>
                </div>
                <!--<i style="padding: 1%" id="category" class="weui-icon-circle"></i>-->
                <form class="weui-search-bar__form" action="/erhuo/index.php/chat/index/search" method="post">
            ...
            <div class="page_title" style="margin: 8px">
                <h1 >二货市场</h1>
                <a id="price_sort" href="javascript:sort();"
                   class="weui-btn weui-btn_default sortgroup">价格排序</a>
        ...
        <div style="text-align: center">
            <li><a href="http://www.miibeian.gov.cn/" target="_blank">京ICP备18004070号</a></li>
        </div>
